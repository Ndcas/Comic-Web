...
// => truyen (Truyen có join với NguoiDung để lấy TenTaiKhoan, TheLoaiTruyen đã join với TheLoai)
...
// => chuongTruyens (mảng ChuongTruyen có join với ChuongDaMoKhoa nếu truyền token, nếu GiaChuong = 0 hoặc mảng ChuongDaMoKhoas khác undefined và không rỗng thì là có thể xem)
router.get('/danhSachChuong', controller.danhSachChuong);
