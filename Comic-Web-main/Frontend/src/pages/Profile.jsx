...
import { useAuth } from '../utils/AuthContext.jsx'; // Lấy user, logout, updateToken
import { getProfile, doiTenTaiKhoan } from '../utils/request.js'; // Lấy API vừa tạo
import { useNavigate, Link } from 'react-router-dom';
import { 
    User, Mail, Calendar, Settings, 
    AlertTriangle, LogOut, Loader2, Edit, Save 
} from 'lucide-react';
...
const Profile = () => {
    ...
    const handleSaveUsername = async () => {
        ...
        try {
            ...
            // 2. Cập nhật state local với tên mới
            setProfileData(prev => ({ ...prev, TenTaiKhoan: trimmedNewUsername }));
            
            // 3. Cập nhật AuthContext/Local Storage với token và tên mới
            ...
            <div className="bg-white dark:bg-gray-800 shadow-xl rounded-xl p-6 md:p-10">
                <div className="flex items-center space-x-6 border-b pb-6 mb-6 dark:border-gray-700">
                    <div className="w-16 h-16 rounded-full bg-red-500 flex items-center justify-center text-white text-3xl font-bold">
                        {/* Hiển thị chữ cái đầu của Tên Tài Khoản hoặc Email */}
